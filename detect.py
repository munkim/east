...
def restore_rectangle_from_rbox(origin, geometry):
    d = geometry[:, :4]
    angle = geometry[:, 4]
...
def detect(F_score, F_geo, F_score_thresh=0.8, F_geo_thresh=0.1, nms_thres=0.2):
    ...
    # restoration
    text_box_restored = restore_rectangle_from_rbox(xy_text[:, ::-1]*4, F_geo[xy_text[:, 0], xy_text[:, 1], :])  # N*4*2
